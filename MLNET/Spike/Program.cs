...
namespace Spike
{
    ...
    public class Program
    {
        ...
        static void Main()
        {
            ...
            var pipeline = context.Transforms.IidSpikeEstimator(
            ...
            var pipeline2 = context.Transforms.IidChangePointEstimator(
                outputColumnName: nameof(SalesPrediction.Prediction), 
                inputColumnName: nameof(SalesRecord.Sales), 
                confidence: 95, 
            ...
            pl.eop();
            Console.WriteLine("Saving output file: data.png");
        }
    }
}